                ...
                {!bool && <div className="divtop" style={{ backgroundImage: `url(${back2})`, backgroundRepeat: "no-repeat", backgroundSize: "contain", height: 770, width: 1320 }}>
                    ...
                    <div className="div1">
                        <div className="rightbar">
                            ...
                            <h5 style={{ color: 'White', fontSize: "16px" }}>Let Images Speak <br />Upload an Image to Generate Captivating Captions!</h5>

                           

                            <input type="file" style={{color:"White"}} onChange={handleImageChange} />
